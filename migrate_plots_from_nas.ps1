...
# TODO change folders to be source folders 
# TODO add destination folders list
# TODO add a switch to toggle between HDDs and specified desintation folders
...
foreach ($PlotFile in $PlotFilesToMove)
{
    ...
    try
    {
        Start-BitsTransfer -Source $PlotFile.FullName -Destination $DestinationPath `
